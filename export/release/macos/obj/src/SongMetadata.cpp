...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_314_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",314,0x0d86f62d)
...
HXLINE( 318)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 317)		this->week = 0;
HXLINE( 316)		this->songName = HX_("",00,00,00,00);
HXLINE( 322)		this->songName = song;
HXLINE( 323)		this->week = week;
HXLINE( 324)		this->songCharacter = songCharacter;
            	}
