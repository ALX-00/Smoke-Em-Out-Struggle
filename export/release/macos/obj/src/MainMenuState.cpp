...
static const ::String _hx_array_data_205e8859_1[] = {
	HX_("story mode",6e,d7,a7,5e),HX_("freeplay",a0,90,86,22),HX_("donate",6f,f1,29,2e),
};
...
HXLINE(  59)		bg1->screenCenter(null());
...
HXLINE(  66)		 ::flixel::FlxSprite _hx_tmp =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  66)		::String library1 = null();
HXDLIN(  66)		this->magenta = _hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE(  67)		this->magenta->scrollFactor->set_x(( (Float)(0) ));
HXLINE(  68)		this->magenta->scrollFactor->set_y(((Float)0.18));
HXLINE(  69)		 ::flixel::FlxSprite _hx_tmp1 = this->magenta;
HXDLIN(  69)		_hx_tmp1->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.1))),null());
HXLINE(  70)		this->magenta->updateHitbox();
HXLINE(  71)		this->magenta->screenCenter(null());
...
HXLINE(  91)				menuItem->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXLINE( 200)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_114_update)
HXLINE( 113)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 115)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 117)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 117)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
...
HXLINE( 204)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
