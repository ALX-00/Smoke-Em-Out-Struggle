...
HXDLIN( 103)			::haxe::Log_obj::trace((HX_("should have logged: ",b3,75,8c,3a) + HX_("Fresh",4e,f6,b3,99)),::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),187,HX_("NGio",5f,e0,c4,33),HX_("logEvent",f6,04,cb,60)));
            		}
