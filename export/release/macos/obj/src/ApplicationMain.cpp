...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("vsgarcello",b2,c4,22,02),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("1115",c4,cd,88,20));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("ninjamuffin99",f7,4c,e5,00));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("vsgarcello",b2,c4,22,02));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("FNF | Smoke 'Em Out Struggle",17,cf,60,03));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("FNF | Smoke 'Em Out Struggle",17,cf,60,03))
