...
static const ::String _hx_array_data_b3f26131_16[] = {
	HX_("Headache",9f,21,41,1b),HX_("Nerves",09,f1,02,a3),HX_("Release",a7,ad,3e,26),
};
static const ::String _hx_array_data_b3f26131_17[] = {
	HX_("garcello",75,58,5d,9d),HX_("garcellotired",67,6a,3e,11),HX_("garcellodead",99,85,31,f3),
};
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_164_addSong,"FreeplayState","addSong",0x9e966259,"FreeplayState.addSong","FreeplayState.hx",164,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_168_addWeek,"FreeplayState","addWeek",0xa1339e78,"FreeplayState.addWeek","FreeplayState.hx",168,0x0d86f62d)
static const ::String _hx_array_data_b3f26131_21[] = {
	HX_("bf",c4,55,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_183_update,"FreeplayState","update",0x9e1473a6,"FreeplayState.update","FreeplayState.hx",183,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_238_changeDiff,"FreeplayState","changeDiff",0x302511b2,"FreeplayState.changeDiff","FreeplayState.hx",238,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_262_changeSelection,"FreeplayState","changeSelection",0xbe8c8f7f,"FreeplayState.changeSelection","FreeplayState.hx",262,0x0d86f62d)
...
HXDLIN(  82)		if (!(::StoryMenuState_obj::weekUnlocked->__get(7))) {
HXLINE(  82)			_hx_tmp6 = isDebug;
            		}
            		else {
HXLINE(  82)			_hx_tmp6 = true;
            		}
HXDLIN(  82)		if (_hx_tmp6) {
HXLINE(  83)			this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_16,3),7,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_17,3));
            		}
HXLINE(  89)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  89)		::String library1 = null();
HXDLIN(  89)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBGBlue",de,35,e3,1e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
...
HXLINE(  95)		{
HXLINE(  95)			int _g2 = 0;
HXDLIN(  95)			int _g3 = this->songs->length;
HXDLIN(  95)			while((_g2 < _g3)){
HXLINE(  95)				_g2 = (_g2 + 1);
HXDLIN(  95)				int i = (_g2 - 1);
HXLINE(  97)				 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->songs->__get(i).StaticCast<  ::SongMetadata >()->songName,true,false);
...
HXLINE( 102)				 ::HealthIcon icon =  ::HealthIcon_obj::__alloc( HX_CTX ,this->songs->__get(i).StaticCast<  ::SongMetadata >()->songCharacter,null());
HXLINE( 103)				icon->sprTracker = songText;
HXLINE( 106)				this->iconArray->push(icon);
HXLINE( 107)				this->add(icon);
            			}
            		}
HXLINE( 114)		this->scoreText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.7)),5,0,HX_("",00,00,00,00),32,null());
HXLINE( 116)		this->scoreText->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),32,-1,HX_("right",dc,0b,64,e9),null(),null(),null());
HXLINE( 119)		 ::flixel::FlxSprite scoreBG =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(this->scoreText->x - ( (Float)(6) )),0,null());
HXDLIN( 119)		 ::flixel::FlxSprite scoreBG1 = scoreBG->makeGraphic(::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.35))),66,-16777216,null(),null());
HXLINE( 120)		scoreBG1->set_alpha(((Float)0.6));
HXLINE( 121)		this->add(scoreBG1);
HXLINE( 123)		this->diffText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,this->scoreText->x,(this->scoreText->y + 36),0,HX_("",00,00,00,00),24,null());
HXLINE( 124)		this->diffText->set_font(this->scoreText->_font);
HXLINE( 125)		this->add(this->diffText);
HXLINE( 127)		this->add(this->scoreText);
HXLINE( 129)		this->changeSelection(null());
HXLINE( 130)		this->changeDiff(null());
HXLINE( 134)		this->selector =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 136)		this->selector->set_size(40);
HXLINE( 137)		this->selector->set_text(HX_(">",3e,00,00,00));
HXLINE( 140)		 ::Alphabet swag =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(1) ),( (Float)(0) ),HX_("swag",8a,2a,5e,4c),null(),null());
HXLINE( 159)		this->super::create();
            	}


void FreeplayState_obj::addSong(::String songName,int weekNum,::String songCharacter){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_164_addSong)
HXDLIN( 164)		::Array< ::Dynamic> _hx_tmp = this->songs;
HXDLIN( 164)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter));
            	}
...
void FreeplayState_obj::addWeek(::Array< ::String > songs,int weekNum,::Array< ::String > songCharacters){
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_168_addWeek)
HXLINE( 169)		if (::hx::IsNull( songCharacters )) {
HXLINE( 170)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_21,1);
            		}
HXLINE( 172)		int num = 0;
HXLINE( 173)		{
HXLINE( 173)			int _g = 0;
HXDLIN( 173)			while((_g < songs->length)){
HXLINE( 173)				::String song = songs->__get(_g);
HXDLIN( 173)				_g = (_g + 1);
HXLINE( 175)				this->addSong(song,weekNum,songCharacters->__get(num));
HXLINE( 177)				if ((songCharacters->length != 1)) {
HXLINE( 178)					num = (num + 1);
            				}
            			}
            		}
            	}
...
void FreeplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_183_update)
HXLINE( 184)		this->super::update(elapsed);
HXLINE( 186)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.7))) {
HXLINE( 188)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 188)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 191)		Float a = ( (Float)(this->lerpScore) );
HXDLIN( 191)		this->lerpScore = ::Math_obj::floor((a + (((Float)0.4) * (( (Float)(this->intendedScore) ) - a))));
HXLINE( 193)		if ((::Math_obj::abs(( (Float)((this->lerpScore - this->intendedScore)) )) <= 10)) {
HXLINE( 194)			this->lerpScore = this->intendedScore;
            		}
HXLINE( 196)		this->scoreText->set_text((HX_("PERSONAL BEST:",36,ce,e9,ee) + this->lerpScore));
HXLINE( 198)		bool upP = ::PlayerSettings_obj::player1->controls->_upP->check();
HXLINE( 199)		bool downP = ::PlayerSettings_obj::player1->controls->_downP->check();
HXLINE( 200)		bool accepted = ::PlayerSettings_obj::player1->controls->_accept->check();
HXLINE( 202)		if (upP) {
...
HXLINE( 211)		if (::PlayerSettings_obj::player1->controls->_leftP->check()) {
HXLINE( 212)			this->changeDiff(-1);
            		}
HXLINE( 213)		if (::PlayerSettings_obj::player1->controls->_rightP->check()) {
HXLINE( 214)			this->changeDiff(1);
            		}
HXLINE( 216)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 218)			 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 223)			::String poop = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase();
HXDLIN( 223)			::String poop1 = ::Highscore_obj::formatSong(poop,this->curDifficulty);
HXLINE( 225)			::haxe::Log_obj::trace(poop1,::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),225,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 227)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop1,this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase());
HXLINE( 228)			::PlayState_obj::isStoryMode = false;
HXLINE( 229)			::PlayState_obj::storyDifficulty = this->curDifficulty;
HXLINE( 231)			::PlayState_obj::storyWeek = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->week;
HXLINE( 232)			::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),232,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 233)			{
HXLINE( 233)				 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
void FreeplayState_obj::changeDiff(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_238_changeDiff)
HXLINE( 239)		 ::FreeplayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 239)		_hx_tmp->curDifficulty = (_hx_tmp->curDifficulty + change);
HXLINE( 241)		if ((this->curDifficulty < 0)) {
HXLINE( 242)			this->curDifficulty = 2;
            		}
HXLINE( 243)		if ((this->curDifficulty > 2)) {
HXLINE( 244)			this->curDifficulty = 0;
            		}
HXLINE( 247)		this->intendedScore = ::Highscore_obj::getScore(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,this->curDifficulty);
HXLINE( 250)		switch((int)(this->curDifficulty)){
            			case (int)0: {
HXLINE( 253)				this->diffText->set_text(HX_("EASY",02,54,cd,2d));
            			}
            			break;
            			case (int)1: {
HXLINE( 255)				this->diffText->set_text(HX_("NORMAL",27,1e,ec,e2));
            			}
            			break;
            			case (int)2: {
HXLINE( 257)				this->diffText->set_text(HX_("HARD",eb,f6,c8,2f));
            			}
            			break;
            		}
            	}
...
void FreeplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_262_changeSelection)
HXLINE( 264)		{
HXLINE( 264)			::io::newgrounds::NG_obj::core->calls->event->logEvent(HX_("Fresh",4e,f6,b3,99))->send();
HXDLIN( 264)			::haxe::Log_obj::trace((HX_("should have logged: ",b3,75,8c,3a) + HX_("Fresh",4e,f6,b3,99)),::hx::SourceInfo(HX_("source/NGio.hx",4b,1f,9f,05),187,HX_("NGio",5f,e0,c4,33),HX_("logEvent",f6,04,cb,60)));
            		}
HXLINE( 268)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 268)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 270)		 ::FreeplayState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 270)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 272)		if ((this->curSelected < 0)) {
HXLINE( 273)			this->curSelected = (this->songs->length - 1);
            		}
HXLINE( 274)		if ((this->curSelected >= this->songs->length)) {
HXLINE( 275)			this->curSelected = 0;
            		}
HXLINE( 280)		this->intendedScore = ::Highscore_obj::getScore(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,this->curDifficulty);
HXLINE( 285)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN( 285)		_hx_tmp2->playMusic((((HX_("songs:assets/songs/",c1,ed,e6,7e) + this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00)),0,null(),null());
HXLINE( 288)		int bullShit = 0;
HXLINE( 290)		{
HXLINE( 290)			int _g = 0;
HXDLIN( 290)			int _g1 = this->iconArray->length;
HXDLIN( 290)			while((_g < _g1)){
HXLINE( 290)				_g = (_g + 1);
HXDLIN( 290)				int i = (_g - 1);
HXLINE( 292)				this->iconArray->__get(i).StaticCast<  ::HealthIcon >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 295)		this->iconArray->__get(this->curSelected).StaticCast<  ::HealthIcon >()->set_alpha(( (Float)(1) ));
HXLINE( 297)		{
HXLINE( 297)			int _g2 = 0;
HXDLIN( 297)			::Array< ::Dynamic> _g3 = this->grpSongs->members;
HXDLIN( 297)			while((_g2 < _g3->length)){
HXLINE( 297)				 ::Alphabet item = _g3->__get(_g2).StaticCast<  ::Alphabet >();
HXDLIN( 297)				_g2 = (_g2 + 1);
HXLINE( 299)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 300)				bullShit = (bullShit + 1);
HXLINE( 302)				item->set_alpha(((Float)0.6));
HXLINE( 305)				if ((item->targetY == 0)) {
