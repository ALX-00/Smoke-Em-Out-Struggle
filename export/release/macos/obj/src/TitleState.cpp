...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_306_update,"TitleState","update",0x8b12e05e,"TitleState.update","TitleState.hx",306,0xd132a6e5)
...
HXLINE(  47)		 ::TitleState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 158)		this->gfDance =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,150,100,null());
...
HXLINE( 177)		logo1->screenCenter(null());
...
HXLINE( 192)		this->credTextShit->screenCenter(null());
HXLINE( 196)		this->credTextShit->set_visible(false);
HXLINE( 198)		 ::flixel::FlxSprite _hx_tmp6 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.52)),null());
HXDLIN( 198)		::String library4 = null();
HXDLIN( 198)		this->ngSpr = _hx_tmp6->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("newgrounds_logo",1e,5c,8d,a6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library4),null(),null(),null(),null(),null());
HXLINE( 199)		this->add(this->ngSpr);
HXLINE( 200)		this->ngSpr->set_visible(false);
HXLINE( 201)		 ::flixel::FlxSprite _hx_tmp7 = this->ngSpr;
HXDLIN( 201)		_hx_tmp7->setGraphicSize(::Std_obj::_hx_int((this->ngSpr->get_width() * ((Float)0.8))),null());
HXLINE( 202)		this->ngSpr->updateHitbox();
HXLINE( 203)		this->ngSpr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXDLIN( 241)		if (_this->keyManager->checkStatus(70,_this->status)) {
...
HXDLIN( 246)		bool pressedEnter = _this1->keyManager->checkStatus(13,_this1->status);
...
HXDLIN( 271)		if (_hx_tmp) {
            			...
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_306_update)
...
HXLINE( 325)			money->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 326)			{
HXLINE( 326)				 ::Alphabet _g1 = money;
HXDLIN( 326)				_g1->set_y((_g1->y + ((i * 60) + 200)));
            			}
...
HXLINE( 335)		coolText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 336)		{
HXLINE( 336)			 ::Alphabet _g = coolText;
HXDLIN( 336)			_g->set_y((_g->y + ((this->textGroup->length * 60) + 200)));
            		}
