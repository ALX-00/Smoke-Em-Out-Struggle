...
HXLINE(  18)		this->animation->add(HX_("bf",c4,55,00,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_1,2),0,false,isPlayer,null());
HXLINE(  19)		this->animation->add(HX_("bf-car",cb,95,e2,07),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_2,2),0,false,isPlayer,null());
HXLINE(  20)		this->animation->add(HX_("bf-christmas",79,02,f4,24),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_3,2),0,false,isPlayer,null());
HXLINE(  21)		this->animation->add(HX_("bf-pixel",fd,03,90,37),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_4,2),0,false,isPlayer,null());
HXLINE(  22)		this->animation->add(HX_("spooky",eb,bd,9e,c1),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_5,2),0,false,isPlayer,null());
HXLINE(  23)		this->animation->add(HX_("pico",e5,e8,57,4a),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_6,2),0,false,isPlayer,null());
HXLINE(  24)		this->animation->add(HX_("mom",cb,16,53,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_7,2),0,false,isPlayer,null());
HXLINE(  25)		this->animation->add(HX_("mom-car",52,e6,f7,f6),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_8,2),0,false,isPlayer,null());
HXLINE(  26)		this->animation->add(HX_("tankman",f0,7d,78,3d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_9,2),0,false,isPlayer,null());
HXLINE(  27)		this->animation->add(HX_("face",9d,b4,b5,43),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_10,2),0,false,isPlayer,null());
HXLINE(  28)		this->animation->add(HX_("dad",47,36,4c,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_11,2),0,false,isPlayer,null());
HXLINE(  29)		this->animation->add(HX_("senpai",3c,df,8d,6b),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_12,2),0,false,isPlayer,null());
HXLINE(  30)		this->animation->add(HX_("senpai-angry",10,7a,b8,25),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_13,2),0,false,isPlayer,null());
HXLINE(  31)		this->animation->add(HX_("spirit",31,bb,a9,bd),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_14,2),0,false,isPlayer,null());
HXLINE(  32)		this->animation->add(HX_("bf-old",5e,ba,eb,07),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_15,2),0,false,isPlayer,null());
HXLINE(  33)		this->animation->add(HX_("gf",1f,5a,00,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_16,1),0,false,isPlayer,null());
HXLINE(  34)		this->animation->add(HX_("garcello",75,58,5d,9d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_17,2),0,false,isPlayer,null());
HXLINE(  35)		this->animation->add(HX_("garcellotired",67,6a,3e,11),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_18,2),0,false,isPlayer,null());
HXLINE(  36)		this->animation->add(HX_("garcellodead",99,85,31,f3),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_19,2),0,false,isPlayer,null());
HXLINE(  37)		this->animation->add(HX_("garcelloghosty",7f,74,63,3d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_20,2),0,false,isPlayer,null());
HXLINE(  38)		this->animation->add(HX_("parents-christmas",fe,94,c5,32),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_21,1),0,false,isPlayer,null());
HXLINE(  39)		this->animation->add(HX_("monster",1a,54,b0,b8),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_22,2),0,false,isPlayer,null());
HXLINE(  40)		this->animation->add(HX_("monster-christmas",4f,88,85,27),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
