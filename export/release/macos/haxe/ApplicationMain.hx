...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("vsgarcello", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("vsgarcello", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "vsgarcello";
		app.meta["name"] = "FNF | Smoke 'Em Out Struggle";
